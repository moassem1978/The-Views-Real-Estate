...
// Projects section
const Projects = lazy(() => import(/* webpackChunkName: "projects" */ "@/pages/ProjectsWorking"));
const ProjectDetails = lazy(() => import(/* webpackChunkName: "project-details" */ "@/pages/ProjectDetailWorking"));
