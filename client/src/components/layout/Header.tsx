      ...
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        <div className="flex items-center">
          ...
          <div className="mr-10">
            <Link href="/" className="flex items-center">
              ...
              <div className="ml-3 flex flex-col">
                <span className="font-luxury text-rich-black-light text-xl tracking-wider">
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <Link 
              href="/properties" 
              className={`py-2 font-medium ${location === "/properties" 
                ? "text-copper relative after:content-[''] after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-1/2 after:h-0.5 after:bg-copper" 
                : "text-rich-black hover:text-copper"} transition-colors`}
            >
              Properties
        ...
        <div className="flex items-center space-x-4">
          <button className="hidden md:flex items-center justify-center h-10 w-10 rounded-full text-rich-black hover:text-copper hover:bg-cream transition-all">
          ...
          {/* Mobile menu button */}
          <button 
            className="md:hidden flex items-center justify-center h-10 w-10 rounded-full text-rich-black hover:text-copper hover:bg-cream transition-all" 
        ...
        <div className="container mx-auto px-4 py-3">
          <nav className="flex flex-col space-y-3">
            ...
            <div className="flex space-x-4 py-4">
              ...
              <button className="flex items-center justify-center h-10 w-10 rounded-full text-rich-black hover:text-copper hover:bg-cream transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </button>
