...
function AboutSEO() {
  useEffect(() => {
    ...
    metaKeywords.setAttribute('content', 'Mohamed Assem real estate broker, The Views Real Estate founder, Dubai Properties for Egyptians, EMAAR Dubai projects for Egyptian investors, best Dubai real estate broker for Egyptians, Dubai property investment from Egypt, Mohamed Assem Dubai properties, The Views Consultancy Dubai, Dubai golden visa through property Egypt, Red Sea Global Egyptian investment, AMAALA Red Sea Egyptian buyers, Red Sea Project Mohamed Assem, Red Sea Project The Views Consultancy, Saudi Vision 2030 Egyptian investors, luxury real estate Egypt, 30 years experience, best broker in Egypt, most honest broker in Egypt, EMAAR Misr properties, Mivida expert, Marassi North Coast specialist, Sodic Katameya specialist, Palm Hills development expert, Ora developers specialist, luxury property consultant Egypt Dubai Red Sea');
