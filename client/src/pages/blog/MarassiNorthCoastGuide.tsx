...
export default function MarassiNorthCoastGuide() {
  useEffect(() => {
    ...
    const structuredData = {
      ...
      "@type": "Article",
      "headline": "Marassi North Coast by EMAAR Misr | Luxury Beachfront Properties",
      "description": "Discover Marassi North Coast by EMAAR Misr - exclusive luxury villas, chalets and apartments on Egypt's pristine Mediterranean coastline.",
      "author": {
        "@type": "Person",
        "name": "Mohamed Assem",
        "description": "Senior Real Estate Consultant with 30+ years experience"
      },
      "publisher": {
        "@type": "Organization",
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://theviewsrealestate.com/logo.png"
        }
      },
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": "https://theviewsrealestate.com/blog/marassi-north-coast-emaar-complete-guide"
      }
    };
    ...
    return () => {
      const existingScript = document.querySelector('#marassi-structured-data');
      if (existingScript) {
  ...
  return (
    <>
      <Helmet>
        <title>Marassi North Coast by EMAAR Misr | Luxury Beachfront Properties | The Views Real Estate</title>
        <meta name="description" content="Discover Marassi North Coast by EMAAR Misr - exclusive luxury villas, chalets and apartments on Egypt's pristine Mediterranean coastline." />
        <meta name="keywords" content="Marassi North Coast, EMAAR Misr, luxury beachfront properties, North Coast Egypt, Mediterranean villas, premium chalets" />
        <meta property="og:title" content="Marassi North Coast by EMAAR Misr | Luxury Beachfront Properties" />
        <meta property="og:description" content="Discover Marassi North Coast by EMAAR Misr - exclusive luxury villas, chalets and apartments on Egypt's pristine Mediterranean coastline." />
        <meta property="og:type" content="article" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Marassi North Coast by EMAAR Misr" />
        <meta name="twitter:description" content="Egypt's premier luxury Mediterranean resort by EMAAR Misr." />
      </Helmet>
