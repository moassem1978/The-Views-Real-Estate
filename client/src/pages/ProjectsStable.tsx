...
export default function ProjectsStable() {
  return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div className="relative">
                  <div className="w-full h-64 bg-gradient-to-br from-[#f5f5dc] to-[#e6e6fa] flex items-center justify-center">
                    <div className="text-center">
                      <h3 className="text-2xl font-bold text-[#d4af37] mb-2">Marassi North Coast</h3>
                      <p className="text-gray-600">Premium Beachfront Resort</p>
                    </div>
                  </div>
