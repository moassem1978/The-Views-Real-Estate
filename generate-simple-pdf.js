...
// Create a simplified text version of the documentation
const documentation = `
...
fs.writeFileSync('Property_Listing_Form_Documentation.txt', documentation);
console.log('Documentation saved as Property_Listing_Form_Documentation.txt');